package cc.admin.common.system.util;
...
public class JwtUtil {
	 ...
	 * @param request
	 * @return
	 * @throws CcAdminException
	 */
	public static String getUserNameByToken(HttpServletRequest request) throws CcAdminException {
		String accessToken = request.getHeader("Authorization");
		String username = getUsername(accessToken);
		if (oConvertUtils.isEmpty(username)) {
			throw new CcAdminException("未获取到用户");
		}
		return username;
	}
	...
	public static String getUserSystemData(String key,SysUserCacheInfo user) {
		if(user==null) {
			user = BaseDataAutorUtils.loadUserInfo();
		}
		//#{sys_user_code}%
