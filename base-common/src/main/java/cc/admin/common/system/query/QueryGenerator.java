package cc.admin.common.system.query;
...
public class QueryGenerator {
	...
	/**
	 * 组装Mybatis Plus 查询条件
	 * <getPageFilterFields>使用此方法 需要有如下几点注意:
	...
	public static void installMplus(QueryWrapper<?> queryWrapper,Object searchObj,Map<String, String[]> parameterMap) {
		...
		*/
		...
		for (int i = 0; i < origDescriptors.length; i++) {
			//aliasName = origDescriptors[sourceRootPackage].getName();  mybatis  不存在实体属性 不用处理别名的情况
	...
	public static Map<String, SysPermissionDataRuleModel> getRuleMap() {
		...
		List<SysPermissionDataRuleModel> list = BaseDataAutorUtils.loadDataSearchConditon();
