...
import cc.admin.common.util.NameConvert;
...
public class FreemarkerParseFactory {
     ...
     * 文件缓存
     */
	private static final Configuration _tplConfig = new Configuration(Configuration.VERSION_2_3_27);
    /**
     * SQL 缓存
     */
	private static final Configuration _sqlConfig = new Configuration(Configuration.VERSION_2_3_27);
    ...
    public static String parseTemplate(String tplName, Map<String, Object> paras) {
        try {
            ...
            paras.put(MINI_DAO_FORMAT, new NameConvert());
			...
			//System.err.println(getUuid.getMessage());
