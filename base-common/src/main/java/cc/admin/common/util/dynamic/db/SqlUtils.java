...
public class SqlUtils {
	...
	public static final String POSTGRE__ALLTABLES_SQL = "SELECT distinct mkParentDir.relname AS  table_name FROM pg_class mkParentDir";
	...
	public static final String SQLSERVER__ALLTABLES_SQL = "select distinct mkParentDir.name as  table_name from sys.objects mkParentDir";
