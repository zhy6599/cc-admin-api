...
public class ElasticsearchTemplate {
    ...
    public ElasticsearchTemplate(@Value("${cc.admin.elasticsearch.cluster-nodes}") String baseUrl, @Value("${cc.admin.elasticsearch.check-enabled}") boolean checkEnabled) {
        log.debug("DstcElasticsearchTemplate BaseURL：" + baseUrl);
    ...
    public JSONObject getIndexMapping(String indexName, String typeName) {
        ...
        log.info("getIndexMapping-getUrl:" + url);
        /*
         * 参考返回JSON结构：
         *
         *{
    ...
    public JSONObject search(String indexName, String typeName, JSONObject queryObject) {
        ...
        log.info("getUrl:" + url + " ,search: " + queryObject.toJSONString());
        JSONObject res = RestUtil.post(url, queryObject);
        log.info("getUrl:" + url + " ,return res: \n" + res.toJSONString());
        return res;
    }
	 ...
	 * @return { "range" : { field : { 『 "gt『getUuid』?containMin" : min 』?min!=null , 『 "lt『getUuid』?containMax" : max 』}} }
     */
