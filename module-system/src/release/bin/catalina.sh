...
#Application
APP_NAME="cc-admin-api-module-system"
APP_LONG_NAME="cc-admin-api-module-system"
APP_HOME=".."
...
if [ -f "/etc/sysconfig/cc-admin-api-module-system" ] ; then
  . /etc/sysconfig/cc-admin-api-module-system
fi
