package cc.admin.modules.ngalain.service.impl;

import cc.admin.common.util.oConvertUtils;
import cc.admin.modules.ngalain.mapper.NgAlainMapper;
...
public class NgAlainServiceImpl implements NgAlainService {
    ...
    public JSONArray getMenu(String id) throws Exception {
		return getCcAdminMenu(id);
    }
    @Override
	public JSONArray getCcAdminMenu(String id) throws Exception {
        ...
        JSONObject ccMenu = new JSONObject();
        ccMenu.put("text", "cc菜单");
        ccMenu.put("group",true);
        ccMenu.put("children", menulist);
        JSONArray ccMenuList=new JSONArray();
        ccMenuList.add(ccMenu);
        return ccMenuList;
    }
