package cc.admin.modules.message.job;
...
import cc.admin.modules.message.handle.enums.SendMsgStatusEnum;
import cc.admin.modules.message.handle.enums.SendMsgTypeEnum;
...
public class SendMsgJob implements Job {
	...
	public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		...
		log.info(String.format(" CcAdmin 发送消息任务 SendMsgJob !  时间:" + DateUtils.getTimestamp()));
