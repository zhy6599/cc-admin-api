...
import cc.admin.common.system.util.BaseDataAutorUtils;
import cc.admin.common.system.util.JwtUtil;
import cc.admin.common.system.vo.SysPermissionDataRuleModel;
import cc.admin.common.system.vo.SysUserCacheInfo;
...
public class PermissionDataAspect {
	...
	@Pointcut("@annotation(cc.admin.common.aspect.annotation.PermissionData)")
	...
	public Object arround(ProceedingJoinPoint point) throws  Throwable{
		...
		if(currentSyspermission!=null && currentSyspermission.size()>0) {
			...
			if(dataRules!=null && dataRules.size()>0) {
				BaseDataAutorUtils.installDataSearchConditon(request, dataRules);
				SysUserCacheInfo userinfo = sysUserService.getCacheUser(username);
				BaseDataAutorUtils.installUserInfo(request, userinfo);
			}
		}
