...
import cc.admin.modules.system.entity.SysDepartPermission;
import cc.admin.modules.system.entity.SysPermission;
import cc.admin.modules.system.entity.SysPermissionDataRule;
import cc.admin.modules.system.entity.SysRolePermission;
import cc.admin.modules.system.model.SysPermissionTree;
import cc.admin.modules.system.model.TreeModel;
import cc.admin.modules.system.service.ISysDepartPermissionService;
import cc.admin.modules.system.service.ISysPermissionDataRuleService;
import cc.admin.modules.system.service.ISysPermissionService;
import cc.admin.modules.system.service.ISysRolePermissionService;
import cc.admin.modules.system.util.PermissionDataUtil;
	...
	public Result<List<SysPermissionTree>> list(
		...
		try {
			...
			if (StrUtil.isNotEmpty(key)) {
				query.nested(i -> i.like(SysPermission::getName, key).or().like(SysPermission::getComponent, key).or().like(SysPermission::getComponentName, key));
			}
	...
	public Result<List<SysPermissionTree>> getSystemMenuList() {
		...
		try {
			...
			for (SysPermission sysPermission : list) {
				...
				if (!sysPermissionTree.isLeaf()) {
					sysPermissionTree.getChildren().addAll(sysPermissionService.getSystemSubmenu(sysPermissionTree.getId()));
				}
...
//			result.error500("查询失败:" + getUuid.getMessage());
//			log.error(getUuid.getMessage(), getUuid);
//		}
//		return result;
//	}
