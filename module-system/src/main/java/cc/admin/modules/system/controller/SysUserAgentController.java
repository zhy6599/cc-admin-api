...
import cc.admin.modules.system.entity.SysUserAgent;
import cc.admin.modules.system.service.ISysUserAgentService;
...
public class SysUserAgentController {
	...
	public Result<SysUserAgent> queryByUserName(@RequestParam(name="getUserName",required=true) String userName) {
		Result<SysUserAgent> result = new Result<SysUserAgent>();
