...
import cc.admin.modules.sys.entity.SysLog;
import cc.admin.modules.sys.service.ISysLogService;
...
public class AutoLogAspect {
	...
	@Pointcut("@annotation(cc.admin.common.aspect.annotation.AutoLog)")
